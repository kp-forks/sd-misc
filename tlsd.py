...
full_precision_str = params['user_arguments'] + " --googleusercontent --no-gradio-queue --disable-safe-unpickle --xformers --enable-insecure-extension-access --opt-sub-quad-attention --opt-channelslast --api"
