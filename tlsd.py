...
p_str = params['user_arguments'] + " --googleusercontent --no-gradio-queue --listen --disable-safe-unpickle --xformers --enable-insecure-extension-access --opt-sub-quad-attention --opt-channelslast --api"
