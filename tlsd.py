...
full_precision_str = params['user_arguments'] + " --multiple --disable-safe-unpickle --xformers --enable-insecure-extension-access --opt-sub-quad-attention --opt-channelslast --api --port 16888"
